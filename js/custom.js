...
var customScripts = {
    ...
    onePageNav: function () {
		...
		$("a[href='#top']").click(function () {
			...
			$("a[href='#basics']").click(function () {
                $("html, body").animate({ scrollTop: $('#about-us').offset().top - 75 }, "slow"); 
                return false;
            });
    }, 
    owlSlider: function () {
	...
	waySlide: function(){
		   ...
		   ------------------------------------------------------ */		   			  
			$('#club-history').waypoint(function() {				
			$('.design').addClass( 'animated fadeInUp show' );   
			}, { offset: 350 }); 
			
			$('.about-us').waypoint(function() { 
			$('.about-us-image').addClass( 'animated bounceIn' ); 
			$('.about-us-left').addClass( 'animated fadeInLeft show' );   
			$('.about-us-right').addClass( 'animated fadeInRight show' );  
			}, { offset: 350 });
...
$('document').ready(function () {
    customScripts.init();
	$('.about-us-left, .about-us-right, .design, .serviceBox, .owl-wrapper-outer, #portfolio').css('opacity','0');
});